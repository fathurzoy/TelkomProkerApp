...
const SemuaRoute = ({showTambah, username, akses}) => {
  ...
  const tableHead = [
    ...
    <Text style={{paddingLeft: 5, paddingRight: 5, width: 120, color: 'white'}}>
      Nama
    </Text>,
    <Text style={{paddingLeft: 5, paddingRight: 5, width: 110, color: 'white'}}>
      Divisi
    </Text>,
    <Text style={{paddingLeft: 5, paddingRight: 5, width: 100, color: 'white'}}>
      Posisi
    </Text>,
    <Text style={{paddingLeft: 5, paddingRight: 5, width: 120, color: 'white'}}>
      Jenis Kelamin
    ...
    <>
      ...
      <View style={{height: 670}}>
        <View
          ...
          <Text style={{fontSize: 24}}>Staff Semua</Text>
          <View
            style={{
              flexDirection: 'row',
            }}>
            <ExporExcelStaff dataStaff={staffListLimit} title={'SEMUA'} />
            <Gap width={10} />
            <PdfExport dataStaff={staffListLimit} title={'SEMUA'} />
          </View>
        </View>
