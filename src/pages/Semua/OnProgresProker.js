...
const OnProgresProker = ({akses}) => {
  const [prokerListLimitAll, setProkerListLimitAll] = useState([]);
  ...
  const getProkerfListAllLimit = async () => {
    let limit = null;
    ...
    setProkerListLimitAll(datas);
  };
  const getProkerfListAllLimitBulan = async () => {
    let limit = null;
    let datas = await proker_find_many_status({
      page,
      limit,
      ...
      <View style={{height: 670}}>
        <View
          ...
          <View
            ...
            <Gap width={10} />
            <PdfExportProker
              dataProkerCme={prokerListLimitCme}
              dataProkerTransport={prokerListLimitTransport}
              dataProkerIpn={prokerListLimitIpn}
              dataProkerAdmin={prokerListLimitAdmin}
              dataProkerIs={prokerListLimitIs}
              title={'SEMUA'}
              status={'progres'}
              filterMonth={filterMonth}
            />
